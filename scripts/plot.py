...
parser.add_argument('--file_path', default='/global/project/projectdirs/m3246/bnachman/LEP/aleph/processed', help='Folder containing input files')
...
for itrial in range(opt['NTRIAL']):
    mfold = Multifold(version='aleph_trial{}'.format(itrial),verbose=flags.verbose)
    ...
    if itrial==0:
        ...
        fig.savefig('{}/{}.pdf'.format(flags.plot_folder,"Unfolded_Hist_T"))
