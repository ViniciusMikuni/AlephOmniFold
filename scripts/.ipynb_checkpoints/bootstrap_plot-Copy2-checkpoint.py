...
data, mc_reco,mc_gen,reco_mask,gen_mask = utils.DataLoader(flags.file_path,opt,nevts)
# boot_folders=['/pscratch/sd/m/mavaylon/phys_bootstrap/OmniFold/boot_quarter/boot_quarter_'+str(i)+'/*' for i in range(1,11)]
...
fig.savefig('{}/{}_{}.pdf'.format(flags.plot_folder,"Bootstrap_with_Ensemble_Quarter_Boot3",opt['NAME']))
